...
describe('nameHelper', function () {
  ...
  describe('hyphenate', function () {
    ...
    it('should hyphenate a module name ending with pascal case', function () {
      expect(nameHelper.hyphenate('pp.something.SomethingElse')).to.equal('pp-something-something-else');
    });

    it('should hyphenate a module name ending with camel case', function () {
      expect(nameHelper.hyphenate('pp.something.somethingElse')).to.equal('pp-something-something-else');
    });
